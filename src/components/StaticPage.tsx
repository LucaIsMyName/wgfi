...
const mdComponents: React.ComponentProps<typeof ReactMarkdown>["components"] =
  {
    h1: ({ children }) => (
      <h1 className="font-serif text-3xl text-primary-green mt-10 mb-4 first:mt-0">
        {children}
      </h1>
    ),
    h2: ({ children }) => (
...
export const StaticPage: React.FC<Props> = ({ content, title, description }) => (
  <div className="min-h-screen px-6 py-10 md:px-12 md:py-14 bg-main-bg">
    <Helmet>
